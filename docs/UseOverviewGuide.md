...
- **I have single animal videos, but I want to use new features within in DLC2.2:**
   - quick start: when you `create_new_project` just set the flag `multianimal=False`, but you still get lots of upgrades! This is the typical work path for many of you. 
